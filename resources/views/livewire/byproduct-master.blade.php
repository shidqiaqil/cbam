            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Byproduct Master Data</h3>
                        ...
                        <div id="byproduct-table">
                            <div class="table-responsive">
                                <table class="table table-vcenter table-selectable">
                                    ...
                                    <tbody>
                                        @forelse($byproductData as $index => $row)
                                        @php
                                        ...
                                        @endphp
                                        <tr>
                                            <td>{{ ($byproductData->currentPage() - 1) * $byproductData->perPage() +
                                                $index +
                                                1 }}</td>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="18" class="text-center py-4">No Byproduct data matching
                                                filters.
                                ...
                                <div class="d-flex">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" data-bs-toggle="dropdown"
                                            ...
                                            {{ $byproductData->perPage() }} records per page
                                        </button>
                                    ...
                                    <div class="ms-auto d-flex align-items-center">
                                        <span class="text-muted me-3">
                                            Showing {{ ($byproductData->currentPage() - 1) * $byproductData->perPage() +
                                            1
                                            }}
                                            to
                                            {{ min($byproductData->total(), $byproductData->currentPage() *
                                            $byproductData->perPage()) }}
                                            of {{ $byproductData->total() }} results
                                        </span>
                                        {{ $byproductData->links('vendor.livewire.bootstrap') }}
                                    </div>
                                </div>
                            </div>
                        </div>
